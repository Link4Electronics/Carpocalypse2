...
extern tU32 gCredits_scroll_start;
extern int gCredits_line_count;
extern int* gCredits_heights;
extern int* gCredits_throbs;
extern char** gCredits_texts;
extern int* gCredits_fonts;
extern int gCredits_total_height;
