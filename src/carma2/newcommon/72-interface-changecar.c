/*
 * Change-car menu (ported from frontend_changecar.c — real implementation).
 */
#include "72-interface-changecar.h"
...
extern void C2_HOOK_FASTCALL DRS3StartSound(int pOutlet, int pSound_index);
extern int gEffects_outlet;
