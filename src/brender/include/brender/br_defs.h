...
#define BR_SQR2(a, b) BR_MAC2((a), (a), (b), (b))
#define BR_SQR3(a, b, c) BR_MAC3((a), (a), (b), (b), (c), (c))
...
#define BR_SIN(a)  sinf(BrAngleToRadian(a))
#define BR_COS(a)  cosf(BrAngleToRadian(a))
#define BR_TAN(a)  tanf(BrAngleToRadian(a))
