...
// GLOBAL: CARMA2_HW 0x0058c0d0
br_tv_template_entry partCullTemplateEntries[] = {
...
// GLOBAL: CARMA2_HW 0x0058c100
br_tv_template_entry partSurfaceTemplateEntries[] = {
...
// GLOBAL: CARMA2_HW 0x0058c478
br_tv_template_entry partMatrixTemplateEntries[] = {
...
// GLOBAL: CARMA2_HW 0x0058c550
br_tv_template_entry partEnableTemplateEntries[] = {
...
br_tv_template_entry partBoundsTemplateEntries[] = {
...
// GLOBAL: CARMA2_HW 0x0058c298
br_tv_template_entry partLightTemplateEntries[] = {
...
// GLOBAL: CARMA2_HW 0x0058c430
br_tv_template_entry partClipTemplateEntries[] = {
...
// GLOBAL: CARMA2_HW 0x0058c6f8
const soft_state_surface partSurfaceDefault = {
...
// GLOBAL: CARMA2_HW 0x0058c740
const soft_state_light partLightDefault = {
    BRT_NONE,
    BRT_MODEL,
    { { 0.f, 0.f, 0.f, } },
    { { 0.f, 0.f, 0.f, } },
...
// GLOBAL: CARMA2_HW 0x0058c780
const soft_state_clip partClipDefault = {
    BRT_NONE,
    { { 0.f, 0.f, -1.f, 0.f, } },
};

// GLOBAL: CARMA2_HW 0x0058c798
const soft_state_matrix partMatrixDefault = {
    {{
        { 1.f, 0.f, 0.f, },
        { 0.f, 1.f, 0.f, },
        { 0.f, 0.f, 1.f, },
...
// GLOBAL: CARMA2_HW 0x0058c858
const soft_state_enable partEnableDefault = {
    0x2a,
    0,
};

// GLOBAL: CARMA2_HW 0x0058c860
const soft_state_hidden partHiddenSurfaceDefault = {
    BRT_NONE,
    NULL,
    NULL,
    NULL,
...
// GLOBAL: CARMA2_HW 0x0058c880
const soft_state_bounds partBoundsDefault = {
    {{ BR_SCALAR_MAX, BR_SCALAR_MAX, }},
    {{ BR_SCALAR_MIN, BR_SCALAR_MIN, }},
};

// GLOBAL: CARMA2_HW 0x0058c6e8
const soft_state_cull partCullDefault = {
    BRT_NONE,
    BRT_MODEL,
    0,
};

// FUNCTION: CARMA2_HW 0x005414a0
...
br_tv_template* C2_HOOK_STDCALL FindStateTemplate(br_soft_renderer* self, soft_state_all** state, br_token part, br_int_32 index) {
    ...
    case BRT_CULL:
        ...
        C2_HOOK_BUG_ON(BR_ASIZE(partCullTemplateEntries) != 2);
    ...
    case BRT_SURFACE:
        ...
        C2_HOOK_BUG_ON(BR_ASIZE(partSurfaceTemplateEntries) != 17);
    ...
    case BRT_MATRIX:
        ...
        C2_HOOK_BUG_ON(BR_ASIZE(partMatrixTemplateEntries) != 9);
    ...
    case BRT_BOUNDS:
        ...
        C2_HOOK_BUG_ON(BR_ASIZE(partBoundsTemplateEntries) != 4);
    ...
    case BRT_LIGHT:
        ...
        *state = (soft_state_all *)((char *)(*state) + index * sizeof(soft_state_light));
        ...
        entries = partLightTemplateEntries;
        n_entries = BR_ASIZE(partLightTemplateEntries);
        C2_HOOK_BUG_ON(BR_ASIZE(partLightTemplateEntries) != 17);
    ...
    case BRT_CLIP:
        ...
        *state = (soft_state_all *)((char *)(*state) + index * sizeof(soft_state_clip));
        ...
        entries = partClipTemplateEntries;
        n_entries = BR_ASIZE(partClipTemplateEntries);
        C2_HOOK_BUG_ON(BR_ASIZE(partClipTemplateEntries) != 3);
